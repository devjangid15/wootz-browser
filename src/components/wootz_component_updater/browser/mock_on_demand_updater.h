...
#ifndef COMPONENTS_WOOTZ_COMPONENT_UPDATER_BROWSER_MOCK_ON_DEMAND_UPDATER_H_
#define COMPONENTS_WOOTZ_COMPONENT_UPDATER_BROWSER_MOCK_ON_DEMAND_UPDATER_H_
...
#endif  // COMPONENTS_WOOTZ_COMPONENT_UPDATER_BROWSER_MOCK_ON_DEMAND_UPDATER_H_
