...
#ifndef COMPONENTS_WOOTZ_COMPONENT_UPDATER_BROWSER_LOCAL_DATA_FILES_OBSERVER_H_
#define COMPONENTS_WOOTZ_COMPONENT_UPDATER_BROWSER_LOCAL_DATA_FILES_OBSERVER_H_
...
#endif  // COMPONENTS_WOOTZ_COMPONENT_UPDATER_BROWSER_LOCAL_DATA_FILES_OBSERVER_H_
