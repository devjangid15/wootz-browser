...
#ifndef COMPONENTS_TIME_PERIOD_STORAGE_ISO_WEEKLY_STORAGE_H_
#define COMPONENTS_TIME_PERIOD_STORAGE_ISO_WEEKLY_STORAGE_H_
...
#endif  // COMPONENTS_TIME_PERIOD_STORAGE_ISO_WEEKLY_STORAGE_H_
