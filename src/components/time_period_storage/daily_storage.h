...
#ifndef COMPONENTS_TIME_PERIOD_STORAGE_DAILY_STORAGE_H_
#define COMPONENTS_TIME_PERIOD_STORAGE_DAILY_STORAGE_H_
...
#endif  // COMPONENTS_TIME_PERIOD_STORAGE_DAILY_STORAGE_H_
