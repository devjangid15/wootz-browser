...
#ifndef COMPONENTS_WOOTZ_WALLET_BROWSER_ACCOUNT_DISCOVERY_MANAGER_H_
#define COMPONENTS_WOOTZ_WALLET_BROWSER_ACCOUNT_DISCOVERY_MANAGER_H_
...
class AccountDiscoveryManager {
 ...
 private:
  ...
  raw_ptr<wootz_wallet::BitcoinWalletService> bitcoin_wallet_service_;
...
#endif  // COMPONENTS_WOOTZ_WALLET_BROWSER_ACCOUNT_DISCOVERY_MANAGER_H_
