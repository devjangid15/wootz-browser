...
#ifndef COMPONENTS_WOOTZ_WALLET_BROWSER_SIMPLE_HASH_CLIENT_H_
#define COMPONENTS_WOOTZ_WALLET_BROWSER_SIMPLE_HASH_CLIENT_H_
...
#endif  // COMPONENTS_WOOTZ_WALLET_BROWSER_SIMPLE_HASH_CLIENT_H_
