...
#include "components/wootz_wallet/browser/simulation_request_helper.h"
#include "components/wootz_wallet/browser/simulation_response_parser.h"
...
std::optional<std::string> GetRelativeScanPath(const std::string& chain_id,
  ...
  if (coin == mojom::CoinType::ETH) {
    static base::NoDestructor<base::flat_map<std::string, std::string>>
        chain_id_lookup(
            {{wootz_wallet::mojom::kArbitrumMainnetChainId,
              "arbitrum/v0/one/scan"},
             {wootz_wallet::mojom::kArbitrumSepoliaChainId,
              "arbitrum/v0/sepolia/scan"},
             {wootz_wallet::mojom::kAvalancheFujiTestnetChainId,
              "avalanche/v0/fuji/scan"},
             {wootz_wallet::mojom::kAvalancheMainnetChainId,
              "avalanche/v0/mainnet/scan"},
             {wootz_wallet::mojom::kBaseMainnetChainId, "base/v0/mainnet/scan"},
             {wootz_wallet::mojom::kBaseSepoliaTestnetChainId,
              "base/v0/sepolia/scan"},
             {wootz_wallet::mojom::kBlastMainnetChainId,
              "blast/v0/mainnet/scan"},
             {wootz_wallet::mojom::kBlastSepoliaTestnetChainId,
              "blast/v0/sepolia/scan"},
             {wootz_wallet::mojom::kBnbSmartChainMainnetChainId,
              "bnb/v0/mainnet/scan"},
             {wootz_wallet::mojom::kDegenChainId, "degen/v0/mainnet/scan"},
             {wootz_wallet::mojom::kMainnetChainId, "ethereum/v0/mainnet/scan"},
             {wootz_wallet::mojom::kGnosisChainId, "gnosis/v0/mainnet/scan"},
             {wootz_wallet::mojom::kLineaChainId, "linea/v0/mainnet/scan"},
             {wootz_wallet::mojom::kOptimismMainnetChainId,
              "optimism/v0/mainnet/scan"},
             {wootz_wallet::mojom::kOptimismSepoliaChainId,
              "optimism/v0/sepolia/scan"},
             {wootz_wallet::mojom::kPolygonMainnetChainId,
              "polygon/v0/mainnet/scan"},
             {wootz_wallet::mojom::kSepoliaChainId, "ethereum/v0/sepolia/scan"},
             {wootz_wallet::mojom::kZoraChainId, "zora/v0/mainnet/scan"}});
...
const base::flat_map<std::string, std::string> GetHeaders() {
  return {{kBlowfishAPIVersionHeader, kBlowfishAPIVersion},
          ...
          {kWootzServicesKeyHeader, BUILDFLAG(WOOTZ_SERVICES_KEY)}};
}
