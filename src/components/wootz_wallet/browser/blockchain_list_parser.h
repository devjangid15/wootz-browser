...
#ifndef COMPONENTS_WOOTZ_WALLET_BROWSER_BLOCKCHAIN_LIST_PARSER_H_
#define COMPONENTS_WOOTZ_WALLET_BROWSER_BLOCKCHAIN_LIST_PARSER_H_
...
using DappListMap =
    base::flat_map<std::string, std::vector<wootz_wallet::mojom::DappPtr>>;
...
#endif  // COMPONENTS_WOOTZ_WALLET_BROWSER_BLOCKCHAIN_LIST_PARSER_H_
