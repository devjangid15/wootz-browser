...
#ifndef COMPONENTS_WOOTZ_WALLET_BROWSER_ASSET_DISCOVERY_TASK_H_
#define COMPONENTS_WOOTZ_WALLET_BROWSER_ASSET_DISCOVERY_TASK_H_
...
#endif  // COMPONENTS_WOOTZ_WALLET_BROWSER_ASSET_DISCOVERY_TASK_H_
