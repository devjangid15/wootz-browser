...
#ifndef COMPONENTS_WOOTZ_WALLET_BROWSER_ETH_REQUESTS_H_
#define COMPONENTS_WOOTZ_WALLET_BROWSER_ETH_REQUESTS_H_
...
#endif  // COMPONENTS_WOOTZ_WALLET_BROWSER_ETH_REQUESTS_H_
