...
#ifndef COMPONENTS_WOOTZ_WALLET_BROWSER_ASSET_RATIO_SERVICE_H_
#define COMPONENTS_WOOTZ_WALLET_BROWSER_ASSET_RATIO_SERVICE_H_
...
#endif  // COMPONENTS_WOOTZ_WALLET_BROWSER_ASSET_RATIO_SERVICE_H_
