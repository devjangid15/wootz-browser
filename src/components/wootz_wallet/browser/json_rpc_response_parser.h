...
#ifndef COMPONENTS_WOOTZ_WALLET_BROWSER_JSON_RPC_RESPONSE_PARSER_H_
#define COMPONENTS_WOOTZ_WALLET_BROWSER_JSON_RPC_RESPONSE_PARSER_H_
...
#include "components/wootz_wallet/browser/json_rpc_responses.h"
...
#endif  // COMPONENTS_WOOTZ_WALLET_BROWSER_JSON_RPC_RESPONSE_PARSER_H_
