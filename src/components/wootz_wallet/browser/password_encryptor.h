...
#ifndef COMPONENTS_WOOTZ_WALLET_BROWSER_PASSWORD_ENCRYPTOR_H_
#define COMPONENTS_WOOTZ_WALLET_BROWSER_PASSWORD_ENCRYPTOR_H_
...
#endif  // COMPONENTS_WOOTZ_WALLET_BROWSER_PASSWORD_ENCRYPTOR_H_
