...
#ifndef COMPONENTS_WOOTZ_WALLET_BROWSER_KEYRING_SERVICE_PREFS_H_
#define COMPONENTS_WOOTZ_WALLET_BROWSER_KEYRING_SERVICE_PREFS_H_

#include <string>

#include "components/wootz_wallet/common/wootz_wallet.mojom.h"  // IWYU pragma: keep
...
#endif  // COMPONENTS_WOOTZ_WALLET_BROWSER_KEYRING_SERVICE_PREFS_H_
