...
#include "components/wootz_wallet/browser/fil_tx_manager.h"
...
#include "components/wootz_wallet/browser/fil_block_tracker.h"
#include "components/wootz_wallet/browser/fil_nonce_tracker.h"
#include "components/wootz_wallet/browser/fil_transaction.h"
#include "components/wootz_wallet/browser/fil_tx_meta.h"
#include "components/wootz_wallet/browser/fil_tx_state_manager.h"
...
FilTxManager::FilTxManager(TxService* tx_service,
    ...
    : TxManager(std::make_unique<FilTxStateManager>(prefs,
                                                    delegate,
