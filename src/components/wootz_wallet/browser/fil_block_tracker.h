...
#ifndef COMPONENTS_WOOTZ_WALLET_BROWSER_FIL_BLOCK_TRACKER_H_
#define COMPONENTS_WOOTZ_WALLET_BROWSER_FIL_BLOCK_TRACKER_H_
...
#endif  // COMPONENTS_WOOTZ_WALLET_BROWSER_FIL_BLOCK_TRACKER_H_
