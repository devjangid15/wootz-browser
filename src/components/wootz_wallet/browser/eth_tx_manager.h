...
#ifndef COMPONENTS_WOOTZ_WALLET_BROWSER_ETH_TX_MANAGER_H_
#define COMPONENTS_WOOTZ_WALLET_BROWSER_ETH_TX_MANAGER_H_
...
#endif  // COMPONENTS_WOOTZ_WALLET_BROWSER_ETH_TX_MANAGER_H_
