...
#ifndef COMPONENTS_WOOTZ_WALLET_BROWSER_NETWORK_MANAGER_H_
#define COMPONENTS_WOOTZ_WALLET_BROWSER_NETWORK_MANAGER_H_
...
class NetworkManager {
 public:
  ...
  // Get/Set the current chain ID for coin from kWootzWalletSelectedNetworks
  // pref when origin is not presented. If origin is presented,
  // kWootzWalletSelectedNetworksPerOrigin will be used. In addition, if origin
  // is opaque, we will also fallback to kWootzWalletSelectedNetworks but it
...
#endif  // COMPONENTS_WOOTZ_WALLET_BROWSER_NETWORK_MANAGER_H_
