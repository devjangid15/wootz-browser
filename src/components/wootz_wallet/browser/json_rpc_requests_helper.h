...
#ifndef COMPONENTS_WOOTZ_WALLET_BROWSER_JSON_RPC_REQUESTS_HELPER_H_
#define COMPONENTS_WOOTZ_WALLET_BROWSER_JSON_RPC_REQUESTS_HELPER_H_
...
#endif  // COMPONENTS_WOOTZ_WALLET_BROWSER_JSON_RPC_REQUESTS_HELPER_H_
