...
#ifndef COMPONENTS_WOOTZ_WALLET_BROWSER_WOOTZ_WALLET_UTILS_H_
#define COMPONENTS_WOOTZ_WALLET_BROWSER_WOOTZ_WALLET_UTILS_H_
...
// This is mainly used for restoring legacy wootz crypto wallet
...
// Use kWootzWalletLastUnlockTime pref to determine if any wallets has been
...
// WootzWallet/v[chromium-version]. Note that we expose only the Chromium
// version and not the Wootz version because that way no extra entropy
...
#endif  // COMPONENTS_WOOTZ_WALLET_BROWSER_WOOTZ_WALLET_UTILS_H_
