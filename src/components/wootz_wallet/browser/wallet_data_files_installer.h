...
#ifndef COMPONENTS_WOOTZ_WALLET_BROWSER_WALLET_DATA_FILES_INSTALLER_H_
#define COMPONENTS_WOOTZ_WALLET_BROWSER_WALLET_DATA_FILES_INSTALLER_H_
...
#endif  // COMPONENTS_WOOTZ_WALLET_BROWSER_WALLET_DATA_FILES_INSTALLER_H_
