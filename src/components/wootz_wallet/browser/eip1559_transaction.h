...
#ifndef COMPONENTS_WOOTZ_WALLET_BROWSER_EIP1559_TRANSACTION_H_
#define COMPONENTS_WOOTZ_WALLET_BROWSER_EIP1559_TRANSACTION_H_
...
#endif  // COMPONENTS_WOOTZ_WALLET_BROWSER_EIP1559_TRANSACTION_H_
