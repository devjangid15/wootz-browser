...
#ifndef COMPONENTS_WOOTZ_WALLET_BROWSER_WOOTZ_WALLET_SERVICE_H_
#define COMPONENTS_WOOTZ_WALLET_BROWSER_WOOTZ_WALLET_SERVICE_H_
...
#include "components/wootz_wallet/browser/asset_discovery_manager.h"
...
class WootzWalletService : public KeyedService,
                           public mojom::WootzWalletService,
                           public KeyringServiceObserverBase,
                           public WootzWalletServiceDelegate::Observer {
 public:
  ...
  ~WootzWalletService() override;

  WootzWalletService(const WootzWalletService&) = delete;
  WootzWalletService& operator=(const WootzWalletService&) = delete;
  ...
  // mojom::WootzWalletService:
  void AddObserver(::mojo::PendingRemote<mojom::WootzWalletServiceObserver>
                       observer) override;
  ...
  // WootzWalletServiceDelegate::Observer:
  ...
  // Resets things back to the original state of WootzWalletService.
  ...
  WootzWalletP3A* GetWootzWalletP3A();
  ...
  WootzWalletServiceDelegate* GetDelegateForTesting() {
 ...
 private:
  ...
  FRIEND_TEST_ALL_PREFIXES(WootzWalletServiceUnitTest, AddSuggestToken);
  FRIEND_TEST_ALL_PREFIXES(WootzWalletServiceUnitTest, ImportFromMetaMask);
  FRIEND_TEST_ALL_PREFIXES(WootzWalletServiceUnitTest, Reset);
  ...
  void OnWootzWalletNftDiscoveryEnabled();
  ...
  mojo::RemoteSet<mojom::WootzWalletServiceObserver> observers_;
  mojo::RemoteSet<mojom::WootzWalletServiceTokenObserver> token_observers_;
  std::unique_ptr<WootzWalletServiceDelegate> delegate_;
  ...
  std::unique_ptr<WootzWalletP3A> wootz_wallet_p3a_;
  ...
  mojo::ReceiverSet<mojom::WootzWalletService> receivers_;
  mojo::Receiver<wootz_wallet::mojom::KeyringServiceObserver>
      keyring_observer_receiver_{this};
  PrefChangeRegistrar pref_change_registrar_;
  base::WeakPtrFactory<WootzWalletService> weak_ptr_factory_;
};

}  // namespace wootz_wallet

#endif  // COMPONENTS_WOOTZ_WALLET_BROWSER_WOOTZ_WALLET_SERVICE_H_
