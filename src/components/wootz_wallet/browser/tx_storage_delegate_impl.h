...
#ifndef COMPONENTS_WOOTZ_WALLET_BROWSER_TX_STORAGE_DELEGATE_IMPL_H_
#define COMPONENTS_WOOTZ_WALLET_BROWSER_TX_STORAGE_DELEGATE_IMPL_H_
...
class TxStorageDelegateImpl final : public TxStorageDelegate {
 ...
 private:
  ...
  FRIEND_TEST_ALL_PREFIXES(TxStorageDelegateImplUnitTest,
                           WootzWalletTransactionsDBFormatMigrated);
...
#endif  // COMPONENTS_WOOTZ_WALLET_BROWSER_TX_STORAGE_DELEGATE_IMPL_H_
