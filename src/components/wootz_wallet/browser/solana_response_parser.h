...
#ifndef COMPONENTS_WOOTZ_WALLET_BROWSER_SOLANA_RESPONSE_PARSER_H_
#define COMPONENTS_WOOTZ_WALLET_BROWSER_SOLANA_RESPONSE_PARSER_H_
...
#endif  // COMPONENTS_WOOTZ_WALLET_BROWSER_SOLANA_RESPONSE_PARSER_H_
