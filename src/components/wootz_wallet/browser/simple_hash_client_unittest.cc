...
TEST_F(SimpleHashClientUnitTest, GetSimpleHashNftsByWalletUrl) {
  ...
  EXPECT_EQ(simple_hash_client_->GetSimpleHashNftsByWalletUrl(
                ...
                {mojom::kMainnetChainId}, std::nullopt),
            GURL("https://simplehash.wallet.wootz.com/api/v0/nfts/"
...
TEST_F(SimpleHashClientUnitTest, GetNftsUrl) {
  ...
  EXPECT_EQ(
      url,
      GURL("https://simplehash.wallet.wootz.com/api/v0/nfts/assets"
  ...
  nft_ids.push_back(std::move(nft_id));
  url = SimpleHashClient::GetNftsUrl(mojom::CoinType::ETH, nft_ids);
  EXPECT_EQ(url, GURL("https://simplehash.wallet.wootz.com/api/v0/nfts/assets"
  ...
  EXPECT_EQ(
      url,
      GURL(
          "https://simplehash.wallet.wootz.com/api/v0/nfts/assets"
  ...
  nft_ids.push_back(std::move(nft_id));
  url = SimpleHashClient::GetNftsUrl(mojom::CoinType::ETH, nft_ids);
  EXPECT_EQ(url, GURL("https://simplehash.wallet.wootz.com/api/v0/nfts/"
...
TEST_F(SimpleHashClientUnitTest, GetNftMetadatas) {
  ...
  metadata2->image = "https://simplehash.wallet-cdn.wootz.com/assets/3.png";
...
TEST_F(SimpleHashClientUnitTest, FetchSolCompressedNftProofData) {
  ...
  SetInterceptors(
      {{GURL("https://simplehash.wallet.wootz.com/api/v0/nfts/proof/"
