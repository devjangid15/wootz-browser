...
#ifndef COMPONENTS_WOOTZ_WALLET_BROWSER_ZCASH_RUST_EXTENDED_SPENDING_KEY_IMPL_H_
#define COMPONENTS_WOOTZ_WALLET_BROWSER_ZCASH_RUST_EXTENDED_SPENDING_KEY_IMPL_H_

#include <memory>

#include "components/wootz_wallet/browser/zcash/rust/extended_spending_key.h"
...
#endif  // COMPONENTS_WOOTZ_WALLET_BROWSER_ZCASH_RUST_EXTENDED_SPENDING_KEY_IMPL_H_
