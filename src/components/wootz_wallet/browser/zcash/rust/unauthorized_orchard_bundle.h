...
#ifndef COMPONENTS_WOOTZ_WALLET_BROWSER_ZCASH_RUST_UNAUTHORIZED_ORCHARD_BUNDLE_H_
#define COMPONENTS_WOOTZ_WALLET_BROWSER_ZCASH_RUST_UNAUTHORIZED_ORCHARD_BUNDLE_H_
...
class UnauthorizedOrchardBundle {
 public:
  ...
  static std::unique_ptr<UnauthorizedOrchardBundle> Create(
      ...
      const std::vector<::wootz_wallet::OrchardOutput> orchard_outputs,
...
#endif  // COMPONENTS_WOOTZ_WALLET_BROWSER_ZCASH_RUST_UNAUTHORIZED_ORCHARD_BUNDLE_H_
