...
#ifndef COMPONENTS_WOOTZ_WALLET_BROWSER_ZCASH_RUST_EXTENDED_SPENDING_KEY_H_
#define COMPONENTS_WOOTZ_WALLET_BROWSER_ZCASH_RUST_EXTENDED_SPENDING_KEY_H_
...
#endif  // COMPONENTS_WOOTZ_WALLET_BROWSER_ZCASH_RUST_EXTENDED_SPENDING_KEY_H_
