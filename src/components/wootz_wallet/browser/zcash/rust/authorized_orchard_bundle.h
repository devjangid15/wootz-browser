...
#ifndef COMPONENTS_WOOTZ_WALLET_BROWSER_ZCASH_RUST_AUTHORIZED_ORCHARD_BUNDLE_H_
#define COMPONENTS_WOOTZ_WALLET_BROWSER_ZCASH_RUST_AUTHORIZED_ORCHARD_BUNDLE_H_
...
#endif  // COMPONENTS_WOOTZ_WALLET_BROWSER_ZCASH_RUST_AUTHORIZED_ORCHARD_BUNDLE_H_
