...
#ifndef COMPONENTS_WOOTZ_WALLET_BROWSER_INTERNAL_ORCHARD_BUNDLE_MANAGER_H_
#define COMPONENTS_WOOTZ_WALLET_BROWSER_INTERNAL_ORCHARD_BUNDLE_MANAGER_H_
...
#endif  // COMPONENTS_WOOTZ_WALLET_BROWSER_INTERNAL_ORCHARD_BUNDLE_MANAGER_H_
