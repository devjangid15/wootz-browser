...
#ifndef COMPONENTS_WOOTZ_WALLET_BROWSER_PERMISSION_UTILS_H_
#define COMPONENTS_WOOTZ_WALLET_BROWSER_PERMISSION_UTILS_H_
 ...
 * new_origin. If type != kWootzEthereum, there would be separater like
 * https://origin__BrG4...
 */
 ...
 * Example output:
 *   wootzapp://wallet-panel.top-chrome/?addr=0x123&addr=0x456&origin=https://test.com
 */
...
#endif  // COMPONENTS_WOOTZ_WALLET_BROWSER_PERMISSION_UTILS_H_
