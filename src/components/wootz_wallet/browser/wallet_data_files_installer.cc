...
const char kWalletDataFilesDisplayName[] = "Wootz Wallet data files";
...
// <profile>\AppData\Local\Google\Chrome\User Data\WootzWallet\.
...
bool WalletDataFilesInstallerPolicy::IsWootzComponent() const {
  return true;
}
...
void WalletDataFilesInstaller::RegisterWalletDataFilesComponentInternal(
  ...
  installer->Register(
      cus, base::BindOnce([]() {
        wootz_component_updater::WootzOnDemandUpdater::GetInstance()
