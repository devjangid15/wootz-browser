...
#include "components/wootz_wallet/browser/meld_integration_service.h"
  ...
  return net::DefineNetworkTrafficAnnotation("meld_integration_service", R"(
      semantics {
        ...
        description:
          ...
          "the external Meld API  for the Wootz wallet."
        trigger:
...
base::flat_map<std::string, std::string> MakeMeldApiHeaders() {
  base::flat_map<std::string, std::string> request_headers(
      wootz_wallet::MakeWootzServicesKeyHeaders());
  request_headers["accept"] = "application/json";
  request_headers[wootz_wallet::kMeldRpcVersionHeader] =
      wootz_wallet::kMeldRpcVersion;
...
GURL AppendFilterParams(
    GURL url,
    const wootz_wallet::mojom::MeldFilterPtr& filter,
