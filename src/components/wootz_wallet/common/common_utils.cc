...
bool IsNativeWalletEnabled() {
  return base::FeatureList::IsEnabled(features::kNativeWootzWalletFeature);
}

bool IsBitcoinEnabled() {
  return base::FeatureList::IsEnabled(features::kWootzWalletBitcoinFeature);
}

bool IsBitcoinImportEnabled() {
  return IsBitcoinEnabled() && base::FeatureList::IsEnabled(
                                   features::kWootzWalletBitcoinImportFeature);
}

bool IsZCashEnabled() {
  return base::FeatureList::IsEnabled(features::kWootzWalletZCashFeature);
}
