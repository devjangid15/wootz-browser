...
#ifndef COMPONENTS_WOOTZ_WALLET_COMMON_BTC_LIKE_SERIALIZER_STREAM_H_
#define COMPONENTS_WOOTZ_WALLET_COMMON_BTC_LIKE_SERIALIZER_STREAM_H_
...
#endif  // COMPONENTS_WOOTZ_WALLET_COMMON_BTC_LIKE_SERIALIZER_STREAM_H_
