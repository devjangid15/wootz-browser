...
#ifndef COMPONENTS_WOOTZ_WALLET_COMMON_BITCOIN_UTILS_H_
#define COMPONENTS_WOOTZ_WALLET_COMMON_BITCOIN_UTILS_H_
...
#endif  // COMPONENTS_WOOTZ_WALLET_COMMON_BITCOIN_UTILS_H_
