...
#ifndef COMPONENTS_WOOTZ_WALLET_COMMON_ZCASH_UTILS_H_
#define COMPONENTS_WOOTZ_WALLET_COMMON_ZCASH_UTILS_H_
...
struct OrchardOutput {
  uint64_t value = 0;
  std::array<std::uint8_t, ::wootz_wallet::kOrchardRawBytesSize> addr;
...
#endif  // COMPONENTS_WOOTZ_WALLET_COMMON_ZCASH_UTILS_H_
