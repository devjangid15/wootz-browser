...
#ifndef COMPONENTS_WOOTZ_WALLET_COMMON_WEB3_PROVIDER_CONSTANTS_H_
#define COMPONENTS_WOOTZ_WALLET_COMMON_WEB3_PROVIDER_CONSTANTS_H_
...
#endif  // COMPONENTS_WOOTZ_WALLET_COMMON_WEB3_PROVIDER_CONSTANTS_H_
