...
#ifndef COMPONENTS_WOOTZ_WALLET_COMMON_HASH_UTILS_H_
#define COMPONENTS_WOOTZ_WALLET_COMMON_HASH_UTILS_H_
...
// Used for converting domain names in the classic format (ex: wootz.crypto) to
...
#endif  // COMPONENTS_WOOTZ_WALLET_COMMON_HASH_UTILS_H_
