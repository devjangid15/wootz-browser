...
#ifndef COMPONENTS_WOOTZ_WALLET_COMMON_WOOTZ_WALLET_TYPES_H_
#define COMPONENTS_WOOTZ_WALLET_COMMON_WOOTZ_WALLET_TYPES_H_
...
#endif  // COMPONENTS_WOOTZ_WALLET_COMMON_WOOTZ_WALLET_TYPES_H_
