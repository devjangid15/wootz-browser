...
TEST(WootzWalletTypesTest, OverflowWorksAsExpected) {
...
TEST(WootzWalletTypesTest, SolanaSignatureStatusFromValue) {
...
TEST(WootzWalletTypesTest, SolanaSignatureStatusToValue) {
...
TEST(WootzWalletTypesTest, ValidSolidityBits) {
...
TEST(WootzWalletTypesTest, MaxSolidityUint) {
...
TEST(WootzWalletTypesTest, MaxSolidityInt) {
...
TEST(WootzWalletTypesTest, MinSolidityInt) {
