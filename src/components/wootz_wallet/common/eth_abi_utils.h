...
#ifndef COMPONENTS_WOOTZ_WALLET_COMMON_ETH_ABI_UTILS_H_
#define COMPONENTS_WOOTZ_WALLET_COMMON_ETH_ABI_UTILS_H_
...
#endif  // COMPONENTS_WOOTZ_WALLET_COMMON_ETH_ABI_UTILS_H_
