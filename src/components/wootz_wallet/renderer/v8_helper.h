...
#ifndef COMPONENTS_WOOTZ_WALLET_RENDERER_V8_HELPER_H_
#define COMPONENTS_WOOTZ_WALLET_RENDERER_V8_HELPER_H_
...
// but if the user goes into settings and explicitly selects to use Wootz Wallet
...
#endif  // COMPONENTS_WOOTZ_WALLET_RENDERER_V8_HELPER_H_
