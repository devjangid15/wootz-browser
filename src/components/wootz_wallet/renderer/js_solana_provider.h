...
#ifndef COMPONENTS_WOOTZ_WALLET_RENDERER_JS_SOLANA_PROVIDER_H_
#define COMPONENTS_WOOTZ_WALLET_RENDERER_JS_SOLANA_PROVIDER_H_
...
#endif  // COMPONENTS_WOOTZ_WALLET_RENDERER_JS_SOLANA_PROVIDER_H_
