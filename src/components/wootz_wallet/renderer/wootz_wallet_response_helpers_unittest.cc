...
TEST(WootzWalletResponseHelpersTest, GetProviderErrorDictionary) {
...
TEST(WootzWalletResponseHelpersTest,
...
TEST(WootzWalletResponseHelpersTest, ToProviderResponseEmpty) {
...
TEST(WootzWalletResponseHelpersTest, ToProviderResponseSuccess) {
...
TEST(WootzWalletResponseHelpersTest, ToProviderResponseError) {
  base::Value value("test");
