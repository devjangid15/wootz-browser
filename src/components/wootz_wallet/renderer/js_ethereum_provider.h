...
#ifndef COMPONENTS_WOOTZ_WALLET_RENDERER_JS_ETHEREUM_PROVIDER_H_
#define COMPONENTS_WOOTZ_WALLET_RENDERER_JS_ETHEREUM_PROVIDER_H_
...
class JSEthereumProvider final : public gin::Wrappable<JSEthereumProvider>,
 ...
 private:
  ...
  const std::string& GetWootzWalletImage();
  ...
  std::string uuid_;
  std::optional<std::string> wootz_wallet_image_;
  base::WeakPtrFactory<JSEthereumProvider> weak_ptr_factory_{this};
};

}  // namespace wootz_wallet

#endif  // COMPONENTS_WOOTZ_WALLET_RENDERER_JS_ETHEREUM_PROVIDER_H_
