...
#ifndef COMPONENTS_WOOTZ_ADBLOCK_CORE_BROWSER_AD_BLOCK_CUSTOM_RESOURCE_PROVIDER_H_
#define COMPONENTS_WOOTZ_ADBLOCK_CORE_BROWSER_AD_BLOCK_CUSTOM_RESOURCE_PROVIDER_H_
...
#endif  // COMPONENTS_WOOTZ_ADBLOCK_CORE_BROWSER_AD_BLOCK_CUSTOM_RESOURCE_PROVIDER_H_
