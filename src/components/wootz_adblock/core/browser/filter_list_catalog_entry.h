...
#ifndef COMPONENTS_WOOTZ_ADBLOCK_CORE_BROWSER_FILTER_LIST_CATALOG_ENTRY_H_
#define COMPONENTS_WOOTZ_ADBLOCK_CORE_BROWSER_FILTER_LIST_CATALOG_ENTRY_H_
...
#endif  // COMPONENTS_WOOTZ_ADBLOCK_CORE_BROWSER_FILTER_LIST_CATALOG_ENTRY_H_
