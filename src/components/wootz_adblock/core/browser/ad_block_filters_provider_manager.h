...
#ifndef COMPONENTS_WOOTZ_ADBLOCK_CORE_BROWSER_AD_BLOCK_FILTERS_PROVIDER_MANAGER_H_
#define COMPONENTS_WOOTZ_ADBLOCK_CORE_BROWSER_AD_BLOCK_FILTERS_PROVIDER_MANAGER_H_
...
#endif  // COMPONENTS_WOOTZ_ADBLOCK_CORE_BROWSER_AD_BLOCK_FILTERS_PROVIDER_MANAGER_H_
