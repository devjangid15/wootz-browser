...
#ifndef COMPONENTS_WOOTZ_ADBLOCK_CORE_COMMON_WOOTZ_ADBLOCK_CONSTANTS_H_
#define COMPONENTS_WOOTZ_ADBLOCK_CORE_COMMON_WOOTZ_ADBLOCK_CONSTANTS_H_
...
inline constexpr char kWootzAdblock[] = "wootzAdblock";
inline constexpr char kWootzAdblockMetadata[] = "wootzAdblockMetadata";
...
inline constexpr char kAdBlockResourceComponentName[] =
    "Wootz Ad Block Resources Library";
...
inline constexpr char kCookieListEnabledHistogram[] =
    "Wootz.Adblock.CookieListEnabled";
inline constexpr char kCookieListPromptHistogram[] =
    "Wootz.Adblock.CookieListPrompt";

}  // namespace wootz_adblock

#endif  // COMPONENTS_WOOTZ_ADBLOCK_CORE_COMMON_WOOTZ_ADBLOCK_CONSTANTS_H_
