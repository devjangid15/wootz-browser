...
#ifndef COMPONENTS_WOOTZ_ADBLOCK_CONTENT_BROWSER_AD_BLOCK_SUBSCRIPTION_DOWNLOAD_MANAGER_H_
#define COMPONENTS_WOOTZ_ADBLOCK_CONTENT_BROWSER_AD_BLOCK_SUBSCRIPTION_DOWNLOAD_MANAGER_H_
...
#endif  // COMPONENTS_WOOTZ_ADBLOCK_CONTENT_BROWSER_AD_BLOCK_SUBSCRIPTION_DOWNLOAD_MANAGER_H_
