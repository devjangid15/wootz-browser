...
#ifndef COMPONENTS_WOOTZ_ADBLOCK_CONTENT_BROWSER_AD_BLOCK_SERVICE_H_
#define COMPONENTS_WOOTZ_ADBLOCK_CONTENT_BROWSER_AD_BLOCK_SERVICE_H_
...
class AdBlockService {
 ...
 private:
  ...
  friend class wootz_adblock::CosmeticResourceMergeTest;
  friend class wootz_adblock::StripProceduralFiltersTest;
...
#endif  // COMPONENTS_WOOTZ_ADBLOCK_CONTENT_BROWSER_AD_BLOCK_SERVICE_H_
