...
#ifndef COMPONENTS_WOOTZ_ADBLOCK_CONTENT_BROWSER_DOMAIN_BLOCK_CONTROLLER_CLIENT_H_
#define COMPONENTS_WOOTZ_ADBLOCK_CONTENT_BROWSER_DOMAIN_BLOCK_CONTROLLER_CLIENT_H_
...
#endif  // COMPONENTS_WOOTZ_ADBLOCK_CONTENT_BROWSER_DOMAIN_BLOCK_CONTROLLER_CLIENT_H_
