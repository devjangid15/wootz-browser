...
#include "components/wootz_adblock/content/browser/ad_block_localhost_filters_provider.h"
#include "components/wootz_adblock/content/browser/ad_block_subscription_service_manager.h"
#include "components/wootz_adblock/core/browser/ad_block_component_filters_provider.h"
#include "components/wootz_adblock/core/browser/ad_block_component_service_manager.h"
#include "components/wootz_adblock/core/browser/ad_block_custom_resource_provider.h"
#include "components/wootz_adblock/core/browser/ad_block_default_resource_provider.h"
#include "components/wootz_adblock/core/browser/ad_block_filter_list_catalog_provider.h"
#include "components/wootz_adblock/core/browser/ad_block_filters_provider_manager.h"
#include "components/wootz_adblock/core/browser/ad_block_service_helper.h"
...
adblock::BlockerResult AdBlockService::ShouldStartRequest(
  ...
  if (aggressive_blocking ||
      base::FeatureList::IsEnabled(
          wootz_adblock::features::kWootzAdblockDefault1pBlocking) ||
      !SameDomainOrHost(
...
AdBlockService::AdBlockService(
  ...
  if (base::FeatureList::IsEnabled(
          wootz_adblock::features::kBraveLocalhostAccessPermission)) {
