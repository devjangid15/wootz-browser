...
#include "components/p3a/utils.h"
...
void RecordShieldsDomainSettingCounts(PrefService* profile_prefs,
  ...
  VLOG(1) << "WootzAdblockP3A: Recording counts: is_fp=" << is_fingerprint
...
void RecordShieldsDomainSettingCountsWithChange(PrefService* profile_prefs,
  ...
  if (prev_setting != nullptr) {
    ...
    VLOG(1) << "WootzAblockP3A: Decreasing prev setting count: prev_setting="
  ...
  VLOG(1) << "WootzAblockP3A: Increasing new setting count: new_setting="
...
void MaybeRecordInitialShieldsSettings(PrefService* profile_prefs,
  ...
  VLOG(1) << "WootzAblockP3A: Starting initial report for profile";
  ...
  VLOG(1) << "WootzAblockP3A: Domain FP counts: allow=" << fp_counts.allow
          << " standard=" << fp_counts.standard
          << " agg=" << fp_counts.aggressive;
  VLOG(1) << "WootzAblockP3A: Domain Ad counts: allow=" << ads_counts.allow
