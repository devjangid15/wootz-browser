...
#ifndef COMPONENTS_WOOTZ_ADBLOCK_CONTENT_BROWSER_AD_BLOCK_ENGINE_H_
#define COMPONENTS_WOOTZ_ADBLOCK_CONTENT_BROWSER_AD_BLOCK_ENGINE_H_
...
class WootzAdBlockTPNetworkDelegateHelperTest;
...
class AdBlockEngine {
 ...
 private:
  ...
  friend class ::WootzAdBlockTPNetworkDelegateHelperTest;
...
#endif  // COMPONENTS_WOOTZ_ADBLOCK_CONTENT_BROWSER_AD_BLOCK_ENGINE_H_
