...
void AdBlockEngine::OnFilterSetLoaded(rust::Box<adblock::FilterSet> filter_set,
  ...
  TRACE_EVENT_BEGIN1("wootz.adblock", "MakeEngineWithRules",
                     "is_default_engine", is_default_engine_);

  auto result = adblock::engine_from_filter_set(std::move(filter_set));

  TRACE_EVENT_END0("wootz.adblock", "MakeEngineWithRules");
  if (is_default_engine_) {
    base::UmaHistogramTimes("Wootz.Adblock.MakeEngineWithRules.Default",
                            timer.Elapsed());
  } else {
    base::UmaHistogramTimes("Wootz.Adblock.MakeEngineWithRules.Additional",
                            timer.Elapsed());
  }
...
void AdBlockEngine::OnListSourceLoaded(const DATFileDataBuffer& filters,
  ...
  base::ElapsedTimer timer;
  TRACE_EVENT_BEGIN2("wootz.adblock", "MakeEngineWithRules", "size",
...
void AdBlockEngine::OnDATLoaded(const DATFileDataBuffer& dat_buf,
  ...
  base::ElapsedTimer timer;
  TRACE_EVENT_BEGIN2("wootz.adblock", "EngineDeserialize", "size",
  ...
  TRACE_EVENT_END0("wootz.adblock", "EngineDeserialize");
  if (is_default_engine_) {
    base::UmaHistogramTimes("Wootz.Adblock.EngineDeserialize.Default",
                            timer.Elapsed());
  } else {
    base::UmaHistogramTimes("Wootz.Adblock.EngineDeserialize.Additional",
                            timer.Elapsed());
  }
