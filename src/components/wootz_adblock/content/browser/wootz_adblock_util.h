...
#ifndef COMPONENTS_WOOTZ_ADBLOCK_CONTENT_BROWSER_wootz_adblock_UTIL_H_
#define COMPONENTS_WOOTZ_ADBLOCK_CONTENT_BROWSER_wootz_adblock_UTIL_H_
...
#endif  // COMPONENTS_WOOTZ_ADBLOCK_CONTENT_BROWSER_wootz_adblock_UTIL_H_
