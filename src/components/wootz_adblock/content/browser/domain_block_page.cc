...
void DomainBlockPage::PopulateInterstitialStrings(
  ...
  load_time_data.Set("tabTitle", wootz_l10n::GetLocalizedResourceUTF16String(
                                     IDS_DOMAIN_BLOCK_TITLE));
  load_time_data.Set("heading", wootz_l10n::GetLocalizedResourceUTF16String(
                                    IDS_DOMAIN_BLOCK_HEADING));

  load_time_data.Set("primaryParagraph",
                     wootz_l10n::GetLocalizedResourceUTF16String(
  ...
  load_time_data.Set("goBackText", wootz_l10n::GetLocalizedResourceUTF16String(
