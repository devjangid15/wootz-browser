...
#include "components/wootz_adblock/content/browser/domain_block_navigation_throttle.h"
...
#include "components/wootz_adblock/content/browser/domain_block_controller_client.h"
#include "components/wootz_adblock/content/browser/domain_block_page.h"
#include "components/wootz_adblock/content/browser/domain_block_tab_storage.h"
#include "components/wootz_adblock/core/common/features.h"
#include "components/ephemeral_storage/ephemeral_storage_service.h"
#include "content/public/browser/devtools/adblock_devtools_instumentation.h"
...
namespace {
wootz_adblock::DomainBlockNavigationThrottle::BlockResult
ShouldBlockDomainOnTaskRunner(wootz_adblock::AdBlockService* ad_block_service,
                              const GURL& url,
                              bool aggressive_setting) {
  SCOPED_UMA_HISTOGRAM_TIMER("Wootz.DomainBlock.ShouldBlock");
  wootz_adblock::DomainBlockNavigationThrottle::BlockResult block_result;
...
DomainBlockNavigationThrottle::WillStartRequest() {
  ...
  DomainBlockingType domain_blocking_type =
      wootz_adblock::GetDomainBlockingType(content_settings_, request_url);
  ...
  bool aggressive_mode =
      wootz_adblock::GetCosmeticFilteringControlType(
          content_settings_, request_url) == wootz_adblock::ControlType::BLOCK;
