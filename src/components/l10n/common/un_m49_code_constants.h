...
#ifndef COMPONENTS_L10N_COMMON_UN_M49_CODE_CONSTANTS_H_
#define COMPONENTS_L10N_COMMON_UN_M49_CODE_CONSTANTS_H_
...
#endif  // COMPONENTS_L10N_COMMON_UN_M49_CODE_CONSTANTS_H_
