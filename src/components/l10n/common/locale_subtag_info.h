...
#ifndef COMPONENTS_L10N_COMMON_LOCALE_SUBTAG_INFO_H_
#define COMPONENTS_L10N_COMMON_LOCALE_SUBTAG_INFO_H_
...
#endif  // COMPONENTS_L10N_COMMON_LOCALE_SUBTAG_INFO_H_
