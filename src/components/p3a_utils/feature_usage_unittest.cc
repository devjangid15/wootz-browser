...
constexpr char kFirstUsagePrefName[] = "wootz.feature_usage.first_use";
constexpr char kLastUsagePrefName[] = "wootz.feature_usage.last_use";
constexpr char kUsedSecondDayPrefName[] = "wootz.feature_usage.used_second_day";
constexpr char kDaysInMonthPrefName[] = "wootz.feature_usage.days_in_month";
constexpr char kDaysInWeekPrefName[] = "wootz.feature_usage.days_in_week";

constexpr char kNewUserReturningHistogramName[] =
    "Wootz.Feature.NewUserReturning";
constexpr char kDaysInMonthHistogramName[] = "Wootz.Feature.DaysInMonth";
constexpr char kDaysInWeekHistogramName[] = "Wootz.Feature.DaysInWeek";
constexpr char kLastUsageTimeHistogramName[] = "Wootz.Feature.LastUsageTime";
