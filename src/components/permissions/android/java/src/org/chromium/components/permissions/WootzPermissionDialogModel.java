...
class WootzPermissionDialogModel {
    // Link for Widevine
    private static final String URL_WIDEVINE_LEARN_MORE =
            "https://support.wootz.com/hc/en-us/articles/17428756610061";
    ...
    public static PropertyModel getModel(
        ...
        WootzPermissionDialogDelegate wootzDelegate =
                (WootzPermissionDialogDelegate) (Object) delegate;
        PropertyModel model = null;
        if (wootzDelegate.getIsWidevinePermissionRequest()) {
    ...
    private static PropertyModel createModelForWidevineRequest(
        ...
        SpannableString learnMoreLink = SpanApplier.applySpans(
                ...
                new SpanApplier.SpanInfo("<LINK>", "</LINK>",
                        new NoUnderlineClickableSpan(context, R.color.wootz_link, result -> {
        ...
        checkbox.setOnCheckedChangeListener(
                (buttonView, isChecked) -> { wootzDelegate.setDontAskAgain(isChecked); });
    ...
    private static void addLifetimeOptions(View customView, PermissionDialogDelegate delegate) {
        ...
        String[] lifetimeOptions = wootzDelegate.getLifetimeOptions();
        ...
        lifetimeOptionsText.setText(wootzDelegate.getLifetimeOptionsText());
        ...
        radioGroup.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(RadioGroup group, int checkedId) {
                wootzDelegate.setSelectedLifetimeOption(checkedId);
            }
        });
        radioGroup.check(0);
