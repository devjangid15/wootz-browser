...
#ifndef COMPONENTS_PERMISSIONS_PERMISSION_EXPIRATION_KEY_H_
#define COMPONENTS_PERMISSIONS_PERMISSION_EXPIRATION_KEY_H_
...
#endif  // COMPONENTS_PERMISSIONS_PERMISSION_EXPIRATION_KEY_H_
