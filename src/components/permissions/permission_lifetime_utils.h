...
#ifndef COMPONENTS_PERMISSIONS_PERMISSION_LIFETIME_UTILS_H_
#define COMPONENTS_PERMISSIONS_PERMISSION_LIFETIME_UTILS_H_

#include <vector>

#include "base/time/time.h"
#include "components/permissions/permission_lifetime_options.h"
...
#endif  // COMPONENTS_PERMISSIONS_PERMISSION_LIFETIME_UTILS_H_
