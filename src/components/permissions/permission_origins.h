...
#ifndef COMPONENTS_PERMISSIONS_PERMISSION_ORIGINS_H_
#define COMPONENTS_PERMISSIONS_PERMISSION_ORIGINS_H_
...
#endif  // COMPONENTS_PERMISSIONS_PERMISSION_ORIGINS_H_
