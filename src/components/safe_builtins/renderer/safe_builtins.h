...
#ifndef COMPONENTS_SAFE_BUILTINS_RENDERER_SAFE_BUILTINS_H_
#define COMPONENTS_SAFE_BUILTINS_RENDERER_SAFE_BUILTINS_H_
...
class SafeBuiltins {
 ...
 public:
  ...
  // //components/wootz_wallt/resources for now.
...
#endif  // COMPONENTS_SAFE_BUILTINS_RENDERER_SAFE_BUILTINS_H_
