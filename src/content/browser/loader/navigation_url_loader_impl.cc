...
std::unique_ptr<network::ResourceRequest> CreateResourceRequest(
  ...
  new_request->cors_exempt_headers.SetHeader("Origin", "*");
  new_request->cors_exempt_headers.SetHeader("Access-Control-Request-Method", "*");
  new_request->cors_exempt_headers.SetHeader("Access-Control-Request-Headers", "*");
