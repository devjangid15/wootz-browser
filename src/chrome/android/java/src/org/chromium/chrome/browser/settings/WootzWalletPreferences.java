...
public class WootzWalletPreferences extends WootzPreferenceFragment
        implements ConnectionErrorHandler, Preference.OnPreferenceChangeListener {
    private static final String TAG = "WalletPreferences";
    private static final String PREF_WOOTZ_WALLET_AUTOLOCK = "pref_wootz_wallet_autolock";

    /**
     * @noinspection unused
     */
    private static final String PREF_WOOTZ_WALLET_RESET = "pref_wootz_wallet_reset";

    private static final String WOOTZ_WALLET_WEB3_NOTIFICATION_SWITCH = "web3_notifications_switch";
    private static final String WOOTZ_WALLET_WEB3_NFT_DISCOVERY_SWITCH =
            "nft_auto_discovery_switch";
    private static final String WOOTZ_WALLET_WEB3_NFT_DISCOVERY_LEARN_MORE =
            "nft_auto_discovery_learn_more";
    // A global preference, default state is on
    public static final String PREF_WOOTZ_WALLET_WEB3_NOTIFICATIONS =
            "pref_wootz_wallet_web3_notifications";
    ...
    private WootzDialogPreference mDefaultEthereumWallet;
    private WootzDialogPreference mDefaultSolanaWallet;
    private WootzWalletAutoLockPreferences mPrefAutolock;
    ...
    public static boolean getPrefWeb3NotificationsEnabled() {
        ...
        return sharedPreferences.getBoolean(PREF_WOOTZ_WALLET_WEB3_NOTIFICATIONS, true);
    }
    ...
    public void onCreatePreferences(@Nullable Bundle savedInstanceState, @Nullable String rootKey) {
        ...
        requireActivity().setTitle(R.string.wootz_ui_wootz_wallet);
        SettingsUtils.addPreferencesFromResource(this, R.xml.wootz_wallet_preferences);
        ...
        mPrefAutolock = findPreference(PREF_WOOTZ_WALLET_AUTOLOCK);
        mWeb3NotificationsSwitch = findPreference(WOOTZ_WALLET_WEB3_NOTIFICATION_SWITCH);
    ...
    private void setupDefaultWalletPreference(
            @NonNull final WootzDialogPreference walletPreference,
            @DefaultWallet.EnumType final Integer defaultWallet) {
        walletPreference.setEnabled(true);
        if (defaultWallet == DefaultWallet.WOOTZ_WALLET_PREFER_EXTENSION) {
    ...
    private void setUpNftDiscoveryPreference() {
        ...
        mWeb3NftDiscoverySwitch = findPreference(WOOTZ_WALLET_WEB3_NFT_DISCOVERY_SWITCH);
        mWalletModel
                .getCryptoModel()
        ...
        TextMessagePreference learnMorePreference =
                findPreference(WOOTZ_WALLET_WEB3_NFT_DISCOVERY_LEARN_MORE);
    ...
    public void setPrefWeb3NotificationsEnabled(boolean enabled) {
        ...
        sharedPreferencesEditor.putBoolean(PREF_WOOTZ_WALLET_WEB3_NOTIFICATIONS, enabled);
    ...
    public boolean onPreferenceChange(@NonNull Preference preference, Object object) {
        ...
        if (PREF_DEFAULT_ETHEREUM_WALLET.equals(key) && mWalletModel != null) {
            ...
            mWalletModel.getWootzWalletService().setDefaultEthereumWallet(defaultEthereumWallet);
            ...
            mWalletModel.getWootzWalletService().setDefaultSolanaWallet(defaultSolanaWallet);
            setupDefaultWalletPreference(mDefaultSolanaWallet, defaultSolanaWallet);
        } else if (WOOTZ_WALLET_WEB3_NOTIFICATION_SWITCH.equals(key)) {
            setPrefWeb3NotificationsEnabled((boolean) object);
        } else if (WOOTZ_WALLET_WEB3_NFT_DISCOVERY_SWITCH.equals(key) && mWalletModel != null) {
    ...
    private int convertToNativeDefaultWallet(final Integer defaultWallet) {
        if (defaultWallet == 1) {
            return DefaultWallet.WOOTZ_WALLET_PREFER_EXTENSION;
        } else {
