...
import org.chromium.chrome.browser.wootz_wallet.util.AsyncUtils.GetBlockchainTokensBalancesResponseContext;
import org.chromium.chrome.browser.wootz_wallet.util.AsyncUtils.GetErc20TokenBalanceResponseContext;
import org.chromium.chrome.browser.wootz_wallet.util.AsyncUtils.GetErc721TokenBalanceResponseContext;
import org.chromium.chrome.browser.wootz_wallet.util.AsyncUtils.GetNativeAssetsBalancesResponseContext;
...
public class BalanceHelper {
    ...
    public static void getP3ABalances(WeakReference<WootzWalletBaseActivity> activityRef,
        ...
        assert wootzWalletService != null && blockchainRegistry != null && keyringService != null
                && jsonRpcService != null;
            ...
            Utils.getP3ANetworks(allNetworks, relevantNetworks -> {
                ...
                for (int coinType : Utils.P3ACoinTypes) {
                    processP3ACoinNetworks(coinType, sortedNetworks.get(coinType), keyringService,
                            jsonRpcService, wootzWalletService, blockchainRegistry, multiResponse,
    ...
    private static void processP3ACoinNetworks(
            ...
            ArrayList<GetBlockchainTokensBalancesResponseContext>
                    blockchainTokensBalancesResponses) {
        if (JavaUtils.anyNull(wootzWalletService, blockchainRegistry, jsonRpcService)) return;
