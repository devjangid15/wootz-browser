...
public class WootzWalletAutoLockPreferences
        extends Preference implements Preference.OnPreferenceClickListener, ConnectionErrorHandler {
    private String TAG = "WootzWalletAutoLockPreferences";

    public static final int WALLET_AUTOLOCK_DEFAULT_TIME = 5;

    private KeyringService mKeyringService;

    public WootzWalletAutoLockPreferences(Context context, AttributeSet attrs) {
        super(context, attrs);
    ...
    private void showWootzWalletAutoLockDialog() {
        LayoutInflater inflater =
                (LayoutInflater) getContext().getSystemService(Context.LAYOUT_INFLATER_SERVICE);
        View view = inflater.inflate(R.layout.wootz_wallet_autolock_layout, null);
        final EditText input = (EditText) view.findViewById(R.id.wootz_wallet_autolock_edittext);
        ...
        AlertDialog alertDialog =
                alert.setTitle(R.string.wootz_wallet_settings_autolock_option)
                        .setView(view)
