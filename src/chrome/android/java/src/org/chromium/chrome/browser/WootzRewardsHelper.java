...
public class WootzRewardsHelper implements LargeIconBridge.LargeIconCallback {
    private static final String PREF_SHOW_WOOTZ_REWARDS_ONBOARDING_MODAL =
            "show_wootz_rewards_onboarding_modal";
    private static final String PREF_SHOW_WOOTZ_REWARDS_ONBOARDING_ONCE =
            "show_wootz_rewards_onboarding_once";
    ...
    public static boolean isRewardsEnabled() {
        WootzRewardsNativeWorker worker = WootzRewardsNativeWorker.getInstance();
    ...
    public static void resetRewards() {
        ...
        ChromeSharedPreferences.getInstance()
                .writeBoolean(PREF_SHOW_WOOTZ_REWARDS_ONBOARDING_MODAL, true);
        ChromeSharedPreferences.getInstance()
                .writeBoolean(PREF_SHOW_WOOTZ_REWARDS_ONBOARDING_ONCE, false);
    ...
    public static boolean shouldShowRewardsOnboardingModalOnDay4() {
        ...
        if (!hasRewardsOnboardingModalShown()
                ...
                && shouldShowWootzRewardsOnboardingModal()
                && wootzRewardsNativeWorker != null
                && wootzRewardsNativeWorker.isSupported()) {
            if (isRewardsEnabled()) {
    ...
    public static boolean shouldShowWootzRewardsOnboardingModal() {
        return ChromeSharedPreferences.getInstance()
                .readBoolean(PREF_SHOW_WOOTZ_REWARDS_ONBOARDING_MODAL, true);
    }

    public static void setShowWootzRewardsOnboardingModal(boolean enabled) {
        ChromeSharedPreferences.getInstance()
                .writeBoolean(PREF_SHOW_WOOTZ_REWARDS_ONBOARDING_MODAL, enabled);
    }

    public static boolean shouldShowWootzRewardsOnboardingOnce() {
        return ChromeSharedPreferences.getInstance()
                .readBoolean(PREF_SHOW_WOOTZ_REWARDS_ONBOARDING_ONCE, false);
    }

    public static void setShowWootzRewardsOnboardingOnce(boolean enabled) {
        ChromeSharedPreferences.getInstance()
                .writeBoolean(PREF_SHOW_WOOTZ_REWARDS_ONBOARDING_ONCE, enabled);
    }
    ...
    public WootzRewardsHelper(Tab tab) {
        mTab = tab;
        assert mTab != null;
    ...
    public static ChromeTabbedActivity getChromeTabbedActivity() {
        return ChromeActivity.getChromeTabbedActivity();
    }

    public static ChromeActivity getChromeActivity()
            throws ChromeActivity.ChromeActivityNotFoundException {
        return ChromeActivity.getChromeActivity();
    }

    public static String getCurrentMonth(
            Calendar currentTime, Resources resources, boolean upperCase) {
        String month = resources.getString(R.string.wootz_ui_month_jan);
        switch (currentTime.get(Calendar.MONTH)) {
            case Calendar.JANUARY:
                month = resources.getString(R.string.wootz_ui_month_jan);
                break;
            case Calendar.FEBRUARY:
                month = resources.getString(R.string.wootz_ui_month_feb);
                break;
            case Calendar.MARCH:
                month = resources.getString(R.string.wootz_ui_month_mar);
                break;
            case Calendar.APRIL:
                month = resources.getString(R.string.wootz_ui_month_apr);
                break;
            case Calendar.MAY:
                month = resources.getString(R.string.wootz_ui_month_may);
                break;
            case Calendar.JUNE:
                month = resources.getString(R.string.wootz_ui_month_jun);
                break;
            case Calendar.JULY:
                month = resources.getString(R.string.wootz_ui_month_jul);
                break;
            case Calendar.AUGUST:
                month = resources.getString(R.string.wootz_ui_month_aug);
                break;
            case Calendar.SEPTEMBER:
                month = resources.getString(R.string.wootz_ui_month_sep);
                break;
            case Calendar.OCTOBER:
                month = resources.getString(R.string.wootz_ui_month_oct);
                break;
            case Calendar.NOVEMBER:
                month = resources.getString(R.string.wootz_ui_month_nov);
                break;
            case Calendar.DECEMBER:
                month = resources.getString(R.string.wootz_ui_month_dec);
                break;
        }
  ...
  public static Tab currentActiveChromeTabbedActivityTab() {
      ChromeTabbedActivity activity = WootzRewardsHelper.getChromeTabbedActivity();
    ...
    public static SpannableString tosSpannableString(String text, int colorRes) {
        ...
        NoUnderlineClickableSpan termsOfServiceClickableSpan =
                new NoUnderlineClickableSpan(context, colorRes, (textView) -> {
                    CustomTabActivity.showInfoPage(context, ChromeActivity.WOOTZ_TERMS_PAGE);
                });

        NoUnderlineClickableSpan privacyPolicyClickableSpan =
                new NoUnderlineClickableSpan(context, colorRes, (textView) -> {
                    CustomTabActivity.showInfoPage(context, ChromeActivity.WOOTZ_PRIVACY_POLICY);
                });
