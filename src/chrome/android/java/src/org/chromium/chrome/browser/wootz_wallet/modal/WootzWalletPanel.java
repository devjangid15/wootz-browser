...
package org.chromium.chrome.browser.wootz_wallet.modal;
...
import org.chromium.chrome.browser.wootz_wallet.activities.AccountSelectorActivity;
...
import org.chromium.chrome.browser.wootz_wallet.util.AssetsPricesHelper;
import org.chromium.chrome.browser.wootz_wallet.util.BalanceHelper;
...
public class WootzWalletPanel implements DialogInterface {
    private static final String TAG = "WootzWalletPanel";
    ...
    public WootzWalletPanel(
                                            ...
                                            (coinType, nativeAssetsBalances) -> {
                                                ...
                                                String fiatBalanceString =
                                                        String.format(
                                                                ...
                                                                "$%,.2f",
                                                                balance * price);
                                                String wootzBalanceString =
                                                        String.format(
                                                                Locale.getDefault(),
                                                                "%.4f %s",
                                                                balance,
                                                                mSelectedNetwork.symbol);
                                                mAmountAsset.setText(wootzBalanceString);
        ...
        mAllAccountsInfoObserver =
                allAccountsInfo -> {
                    ...
                    final WootzWalletService wootzWalletService =
                            mWalletModel.getWootzWalletService();
                    if (wootzWalletService == null) {
                        return;
                    }
    ...
    private void setUpViews() {
        ...
        mPopupView = (ViewGroup) inflater.inflate(R.layout.wootz_wallet_panel_layout, null);
