...
import org.chromium.chrome.browser.wootz_wallet.adapters.RecoveryPhraseAdapter;
import org.chromium.chrome.browser.wootz_wallet.util.ItemOffsetDecoration;
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        recoveryPhraseButton.setOnClickListener(
                v -> {
                    ...
                    if (wootzWalletP3A != null && mIsOnboarding) {
        ...
        recoveryPhraseSkipButton.setOnClickListener(
                v -> {
                    WootzWalletP3a wootzWalletP3A = getWootzWalletP3A();
                    if (wootzWalletP3A != null && mIsOnboarding) {
                        wootzWalletP3A.reportOnboardingAction(
