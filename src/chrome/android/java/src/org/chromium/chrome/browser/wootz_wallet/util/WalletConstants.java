...
public final class WalletConstants {
    ...
    public static final String NFT_DISCOVERY_LEARN_MORE_LINK =
            "https://github.com/wootz/wootz-browser/wiki/NFT-Discovery";

    public static final String WALLET_HELP_CENTER =
            "https://support.wootz.com/hc/en-us/categories/360001059151-Wootz-Wallet";
    ...
    // WootzWalletAddNetworksFragment
    ...
    public static final String[] WOOTZ_WALLET_PREFS = {PREF_SHOW_BRIDGE_INFO_DIALOG};

    public static List<String> SUPPORTED_TOP_LEVEL_CHAIN_IDS =
            Arrays.asList(
                    WootzWalletConstants.MAINNET_CHAIN_ID,
                    WootzWalletConstants.SOLANA_MAINNET,
                    WootzWalletConstants.FILECOIN_MAINNET,
                    WootzWalletConstants.BITCOIN_MAINNET);
    ...
    public static final String SOL_INS_SYSTEM = WootzWalletConstants.SOLANA_SYSTEM_PROGRAM_ID;
    public static final String SOL_INS_TOKEN = WootzWalletConstants.SOLANA_TOKEN_PROGRAM_ID;
    ...
    public static final Map<String, Integer> KNOWN_TEST_CHAINS_MAP =
            Map.of(
                    WootzWalletConstants.GOERLI_CHAIN_ID, CoinType.ETH, //
                    WootzWalletConstants.SEPOLIA_CHAIN_ID, CoinType.ETH, //
                    WootzWalletConstants.LOCALHOST_CHAIN_ID, CoinType.ETH, //
                    WootzWalletConstants.SOLANA_TESTNET, CoinType.SOL, //
                    WootzWalletConstants.SOLANA_DEVNET, CoinType.SOL, //
                    WootzWalletConstants.FILECOIN_TESTNET, CoinType.FIL, //
                    WootzWalletConstants.FILECOIN_ETHEREUM_TESTNET_CHAIN_ID, CoinType.ETH, //
                    WootzWalletConstants.BITCOIN_TESTNET, CoinType.BTC); //
