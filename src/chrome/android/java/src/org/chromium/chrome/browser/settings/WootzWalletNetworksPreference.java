...
/**
 * Wootz Wallet network preference hosted by {@link WootzWalletNetworksPreferenceFragment}. It shows
 * all the networks available and let the user add, edit, or remove them.
 */
public class WootzWalletNetworksPreference extends Preference
        implements ConnectionErrorHandler, NetworkPreferenceAdapter.ItemClickListener {

    private AppCompatButton mAddNetwork;
    private RecyclerView mRecyclerView;
    @Nullable private WootzWalletAddNetworksFragment.Listener mListener;
    private JsonRpcService mJsonRpcService;

    public WootzWalletNetworksPreference(Context context, AttributeSet attrs) {
        super(context, attrs);
        initJsonRpcService();
    }
    ...
    public void setListener(@Nullable WootzWalletAddNetworksFragment.Listener listener) {
        mListener = listener;
    }
     ...
     * to Wootz activity so it's not possible to retrieve activity models.
     */
