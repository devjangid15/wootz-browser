...
import org.chromium.wootz_wallet.mojom.SolanaSendTransactionOptions;
import org.chromium.wootz_wallet.mojom.SolanaTxData;
import org.chromium.wootz_wallet.mojom.TransactionInfo;
import org.chromium.chrome.R;
import org.chromium.chrome.browser.wootz_wallet.activities.AdvanceTxSettingActivity;
import org.chromium.chrome.browser.wootz_wallet.activities.WootzWalletBaseActivity;
import org.chromium.chrome.browser.wootz_wallet.presenters.Amount;
...
import org.chromium.chrome.browser.wootz_wallet.util.ParsedTransactionFees;
...
public class TxFragment extends Fragment {
    ...
    private EthTxManagerProxy getEthTxManagerProxy() {
        ...
        if (activity instanceof WootzWalletBaseActivity) {
            return ((WootzWalletBaseActivity) activity).getEthTxManagerProxy();
        }
        return null;
    }
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container,
        ...
        editGasFee.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                dialog.setContentView(R.layout.wootz_wallet_edit_gas);
                dialog.show();
    ...
    private void setupView(View view) {
        ...
        if (mIsSolanaInstruction) {
            ...
            gasTxTv.setText(R.string.wootz_wallet_allow_spend_transaction_fee);
            totalHeading.setText(R.string.wootz_wallet_confirm_transaction_amount_fee);
            ...
            if (solanaTxData != null && solanaTxData.sendOptions != null) {
                ...
                if (sendTxOptions.maxRetries != null) {
                    ...
                    tvLabel.setText(R.string.wootz_wallet_solana_max_retries);
                ...
                if (sendTxOptions.preflightCommitment != null) {
                    TextView tvLabel = AndroidUtils.makeHeaderTv(requireContext());
                    TextView tvVal = AndroidUtils.makeSubHeaderTv(requireContext());
                    tvLabel.setText(R.string.wootz_wallet_solana_preflight_commitment);
                ...
                if (sendTxOptions.skipPreflight != null) {
                    TextView tvLabel = AndroidUtils.makeHeaderTv(requireContext());
                    TextView tvVal = AndroidUtils.makeSubHeaderTv(requireContext());
                    tvLabel.setText(R.string.wootz_wallet_solana_skip_preflight);
        ...
        gasFeeAmount.setText(
                String.format(getResources().getString(R.string.wootz_wallet_gas_fee_amount),
        ...
        totalAmount.setText(
                String.format(getResources().getString(R.string.wootz_wallet_total_amount),
