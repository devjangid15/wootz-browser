...
import static org.chromium.chrome.browser.wootz_wallet.util.Utils.warnWhenError;

import org.chromium.base.Callbacks;
import org.chromium.wootz_wallet.mojom.AssetPrice;
import org.chromium.wootz_wallet.mojom.AssetRatioService;
import org.chromium.wootz_wallet.mojom.AssetTimePrice;
...
import org.chromium.wootz_wallet.mojom.SolanaFeeEstimation;
            ...
            this.fee =
                    fee.baseFee
                            + (((long) fee.computeUnits * fee.feePerComputeUnit)
                                    / WootzWalletConstants.MICRO_LAMPORTS_PER_LAMPORT);
            this.error = error;
            this.errorMessage = errorMessage;
            super.fireResponseCompleteCallback();
        }
