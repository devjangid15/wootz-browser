...
public class CreateAccountAdapter extends RecyclerView.Adapter<CreateAccountAdapter.ViewHolder> {
    ...
    public CreateAccountAdapter(
            Context context, List<CryptoAccountTypeInfo> wootzAccountTypeInfos) {
        mCryptoAccountTypeInfos = wootzAccountTypeInfos;
    ...
    public interface OnCreateAccountClickListener {
        void onAccountClick(CryptoAccountTypeInfo wootzAccountTypeInfo);
    }
}
