...
public class KeystoreHelper {
    ...
    private static final String WOOTZ_WALLET_ALIAS = "WOOTZ_WALLET_ALIAS";
    ...
    public static String decryptText()
        ...
        SecretKey secretKey =
                ((KeyStore.SecretKeyEntry) keyStore.getEntry(WOOTZ_WALLET_ALIAS, null))
                        .getSecretKey();
