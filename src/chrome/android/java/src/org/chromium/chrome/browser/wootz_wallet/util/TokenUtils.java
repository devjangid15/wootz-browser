...
public class TokenUtils {
     ...
     * WootzWalletService.getUserAssets contains the native asset on init, but:
     ...
     * front
     *
     * See `refreshVisibleTokenInfo` in components/wootz_wallet_ui/common/async/lib.ts.
     */
    ...
    public static void getVisibleUserAssetsFiltered(WootzWalletService wootzWalletService,
            NetworkInfo selectedNetwork, int coinType, TokenType tokenType,
            Callbacks.Callback1<BlockchainToken[]> callback) {
        wootzWalletService.getUserAssets(
     ...
     * @param wootzWalletService WootzWalletService to retrieve user asset from core.
     * @param blockchainRegistry WootzChainRegistry to retrieve all tokens from core.
     ...
     */
    public static void getAllTokensFiltered(WootzWalletService wootzWalletService,
    ...
    public static void getUserOrAllTokensFiltered(WootzWalletService wootzWalletService,
            BlockchainRegistry blockchainRegistry, NetworkInfo selectedNetwork, int coinType,
            TokenType tokenType, boolean userAssetsOnly,
            Callbacks.Callback1<BlockchainToken[]> callback) {
        if (JavaUtils.anyNull(wootzWalletService, blockchainRegistry)) return;
        if (userAssetsOnly)
            getVisibleUserAssetsFiltered(
                    wootzWalletService, selectedNetwork, coinType, tokenType, callback);
        else
            getAllTokensFiltered(
                    wootzWalletService, blockchainRegistry, selectedNetwork, tokenType, callback);
    }
