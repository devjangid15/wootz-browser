...
import static org.chromium.chrome.browser.wootz_wallet.util.WalletConstants.SOLANA_TRANSACTION_TYPES;
...
import org.chromium.wootz_wallet.mojom.BtcTxData;
import org.chromium.wootz_wallet.mojom.FilTxData;
...
import org.chromium.wootz_wallet.mojom.TxData1559;
 ...
 * components/wootz_wallet_ui/common/hooks/transaction-parser.ts.
 */
public class ParsedTransaction extends ParsedTransactionFees {
    ...
    private static String checkForContractAddressError(BlockchainToken[] fullTokenList, String to) {
        ...
        return token != null ? "wootzWalletContractAddressError" : null;
    }
