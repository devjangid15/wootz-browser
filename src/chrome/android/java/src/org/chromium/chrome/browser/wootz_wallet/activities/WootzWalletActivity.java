...
import org.chromium.chrome.browser.wootz_wallet.adapters.WalletOnboardingPagerAdapter;
import org.chromium.chrome.browser.wootz_wallet.adapters.WalletOnboardingPagerAdapter.WalletAction;
...
public class WootzWalletActivity extends WootzWalletBaseActivity implements OnNextPage {
    ...
    protected void triggerLayoutInflation() {
        setContentView(R.layout.activity_wootz_wallet);
        mIsFromDapps = false;
    ...
    public void finishNativeInitialization() {
        ...
        mWalletOnboardingPagerAdapter =
                new WalletOnboardingPagerAdapter(
                        this, mWootzWalletP3A, mRestartSetupAction, mRestartRestoreAction);
