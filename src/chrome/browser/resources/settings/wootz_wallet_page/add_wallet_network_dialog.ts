...
import {NetworkInfo, WootzWalletBrowserProxy, WootzWalletBrowserProxyImpl} from './wootz_wallet_browser_proxy.js';
import {CrInputElement} from 'chrome://resources/cr_elements/cr_input/cr_input.js'
import {getTemplate} from './add_wallet_network_dialog.html.js'
import '../ui/searchable_drop_down_cros.js';

const SettingsWootzAddWalletNetworkDialogElementBase =
...
export class SettingsWootzAddWalletNetworkDialogElement extends SettingsWootzAddWalletNetworkDialogElementBase {
  static get is() {
  ...
  browserProxy_: WootzWalletBrowserProxy = WootzWalletBrowserProxyImpl.getInstance();
...
customElements.define(
  SettingsWootzAddWalletNetworkDialogElement.is, SettingsWootzAddWalletNetworkDialogElement)
