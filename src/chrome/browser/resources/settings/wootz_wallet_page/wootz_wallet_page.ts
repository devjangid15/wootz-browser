...
import {WootzWalletBrowserProxyImpl} from './wootz_wallet_browser_proxy.js';
import {getTemplate} from './wootz_wallet_page.html.js'

const SettingsWootzWalletPageBase =
  WebUiListenerMixin(PrefsMixin(I18nMixin(RouteObserverMixin(PolymerElement))))

/**
 * 'settings-wootz-default-extensions-page' is the settings page containing
 * wootz's default extensions.
 */
class SettingsWootzWalletPage extends SettingsWootzWalletPageBase {
  static get is() {
    return 'settings-wootz-wallet-page'
  }
  ...
  browserProxy_ = WootzWalletBrowserProxyImpl.getInstance()
  ...
  onWootzWalletEnabledChange_() {
    this.browserProxy_.setWootzWalletEnabled(this.$.wootzWalletEnabled.checked);
  }
  ...
  onInputAutoLockMinutes_() {
    ...
    this.setPrefValue('wootz.wallet.auto_lock_minutes', value)
  }
...
customElements.define(
  SettingsWootzWalletPage.is, SettingsWootzWalletPage)
