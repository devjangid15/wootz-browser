...
class HttpsUpgradeBrowserTest : public PlatformBrowserTest {
 public:
  ...
  GURL RunTestCaseNavigation(bool shields_enabled,
    ...
    wootz_adblock::SetBraveShieldsEnabled(ContentSettings(), shields_enabled,
                                          initial_url, nullptr);
...
IN_PROC_BROWSER_TEST_F(HttpsUpgradeBrowserTest, IsolateSettings) {
  ...
  wootz_adblock::SetHttpsUpgradeControlType(normal_map, ControlType::ALLOW,
                                            host1);
  wootz_adblock::SetHttpsUpgradeControlType(incognito_map, ControlType::ALLOW,
                                            host2);
  ...
  EXPECT_EQ(ControlType::ALLOW,
            wootz_adblock::GetHttpsUpgradeControlType(normal_map, host1));
  EXPECT_EQ(ControlType::BLOCK_THIRD_PARTY,
            wootz_adblock::GetHttpsUpgradeControlType(incognito_map, host1));
  EXPECT_EQ(ControlType::BLOCK_THIRD_PARTY,
            wootz_adblock::GetHttpsUpgradeControlType(normal_map, host2));
  EXPECT_EQ(ControlType::ALLOW,
            wootz_adblock::GetHttpsUpgradeControlType(incognito_map, host2));

  // Set strict per-site settings.
  wootz_adblock::SetHttpsUpgradeControlType(normal_map, ControlType::BLOCK,
                                            host1);
  wootz_adblock::SetHttpsUpgradeControlType(incognito_map, ControlType::BLOCK,
                                            host2);
  ...
  EXPECT_EQ(ControlType::BLOCK,
            wootz_adblock::GetHttpsUpgradeControlType(normal_map, GURL()));
  EXPECT_EQ(ControlType::BLOCK,
            wootz_adblock::GetHttpsUpgradeControlType(incognito_map, GURL()));
