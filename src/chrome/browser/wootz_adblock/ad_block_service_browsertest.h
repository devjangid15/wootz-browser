...
#ifndef CHROME_BROWSER_WOOTZ_ADBLOCK_AD_BLOCK_SERVICE_BROWSERTEST_H_
#define CHROME_BROWSER_WOOTZ_ADBLOCK_AD_BLOCK_SERVICE_BROWSERTEST_H_
...
class AdBlockServiceTest : public PlatformBrowserTest {
 ...
 protected:
  ...
  std::vector<std::unique_ptr<wootz_adblock::TestFiltersProvider>>
      source_providers_;
...
#endif  // CHROME_BROWSER_WOOTZ_ADBLOCK_AD_BLOCK_SERVICE_BROWSERTEST_H_
