...
#ifndef CHROME_BROWSER_WOOTZ_ADBLOCK_WOOTZ_ADBLOCK_TAB_HELPER_H_
#define CHROME_BROWSER_WOOTZ_ADBLOCK_WOOTZ_ADBLOCK_TAB_HELPER_H_
...
#include "components/wootz_adblock/core/common/wootz_adblock_panel.mojom.h"
...
using wootz_adblock::mojom::AdBlockMode;
using wootz_adblock::mojom::CookieBlockMode;
using wootz_adblock::mojom::FingerprintMode;
using wootz_adblock::mojom::HttpsUpgradeMode;
...
#endif  // CHROME_BROWSER_WOOTZ_ADBLOCK_WOOTZ_ADBLOCK_TAB_HELPER_H_
