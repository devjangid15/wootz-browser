...
#ifndef CHROME_BROWSER_WOOTZ_ADBLOCK_COOKIE_LIST_OPT_IN_SERVICE_FACTORY_H_
#define CHROME_BROWSER_WOOTZ_ADBLOCK_COOKIE_LIST_OPT_IN_SERVICE_FACTORY_H_
...
#endif  // CHROME_BROWSER_WOOTZ_ADBLOCK_COOKIE_LIST_OPT_IN_SERVICE_FACTORY_H_
