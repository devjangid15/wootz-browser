...
#ifndef CHROME_BROWSER_WOOTZ_WALLET_WOOTZ_WALLET_TAB_HELPER_H_
#define CHROME_BROWSER_WOOTZ_WALLET_WOOTZ_WALLET_TAB_HELPER_H_
...
class WootzWalletTabHelper
    : public content::WebContentsUserData<WootzWalletTabHelper> {
 public:
  explicit WootzWalletTabHelper(content::WebContents* web_contents);
  ~WootzWalletTabHelper() override;
 ...
 private:
  FRIEND_TEST_ALL_PREFIXES(WootzWalletTabHelperUnitTest, GetApproveBubbleURL);
  FRIEND_TEST_ALL_PREFIXES(WootzWalletTabHelperUnitTest,
                           SolanaConnectedAccount);
  friend class content::WebContentsUserData<WootzWalletTabHelper>;
...
#endif  // CHROME_BROWSER_WOOTZ_WALLET_WOOTZ_WALLET_TAB_HELPER_H_
