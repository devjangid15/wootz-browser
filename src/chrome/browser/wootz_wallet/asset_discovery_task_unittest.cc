...
class TestWootzWalletServiceObserverForAssetDiscoveryTask
    : public wootz_wallet::WootzWalletServiceObserverBase {
 public:
  TestWootzWalletServiceObserverForAssetDiscoveryTask() = default;
...
class AssetDiscoveryTaskUnitTest : public testing::Test {
 ...
 protected:
  void SetUp() override {
    scoped_feature_list_.InitWithFeatures(
        {features::kNativeWootzWalletFeature,
         features::kWootzWalletAnkrBalancesFeature},
        {});
    ...
    wallet_service_observer_ =
        std::make_unique<TestWootzWalletServiceObserverForAssetDiscoveryTask>();
  ...
  std::unique_ptr<TestWootzWalletServiceObserverForAssetDiscoveryTask>
      wallet_service_observer_;
