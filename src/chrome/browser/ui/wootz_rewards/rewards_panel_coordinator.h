...
#ifndef CHROME_BROWSER_UI_WOOTZ_REWARDS_REWARDS_PANEL_COORDINATOR_H_
#define CHROME_BROWSER_UI_WOOTZ_REWARDS_REWARDS_PANEL_COORDINATOR_H_
...
#endif  // CHROME_BROWSER_UI_WOOTZ_REWARDS_REWARDS_PANEL_COORDINATOR_H_